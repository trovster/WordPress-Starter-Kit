...
class Classy_Logo extends Classy {
	
	protected $_post_type	= 'logo';
...
//				'post-formats',
	...
	public function init_register_images() {
		add_image_size($this->get_post_type(), 300, 300, true);
	}
	...
	*/
	 ...
	 * @return	mixed 
	 */
	public static function find_by_slug($slug, $post_type = 'logo') {
 ...
 */
if(class_exists('Classy_Logo')) {
	$classy_logo = new Classy_Logo('initialize');
}